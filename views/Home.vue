	...
	main
		nav.index__nav
			header.index__nav--logo
				a(href="#")
					img(src="@/assets/img/logo.svg",alt="佐藤真奈実' Portfolio")
			ul.index__nav--link
				li
					a(href="#top") top
				li
		...
		section.index__profile#about
			div.index__profile--icon
				//- img(src="@/assets/img/pf_icon.jpg",alt="アイコン")
			...
			div
				...
				div.index__rcm--link
					...
					a(:href="`https://github.com/manami-sato/${rcmURL}/`",target="github")
						span GitHub
					a(:href="`/${rcmURL}/`",target="page")
						span more
			div.index__rcm--img
				img(src="@/assets/img/index_rcm_mock.png",alt="Gifcle")
		ul.index__logo
			li(v-for="(ttl,i) in rcmPath")
				a(:href="`/${rcmPath[i]}`",target="page")
					img(:src="require(`@/assets/img/index_logo_${i+1}.svg`)",:alt="rcmAlt[i]")
					img(:src="require(`@/assets/img/index_logo_${i+1}_on.svg`)",:alt="rcmAlt[i]")
		a(href="/web",target="page",v-on:mouseover="worksBnr",v-on:mouseleave="worksBnr").index__work
...
.index__profile {
  ...
  &--icon {
    ...
    margin: 0 auto;
    background: url("~@/assets/img/index_about_icon.png");
    ...
    &:hover {
      background: url("~@/assets/img/index_about_icon_on.png");
      background-size: cover;
      background-position: center, center;
    }
  }
